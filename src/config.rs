...
lazy_static::lazy_static! {
    ...
    map.insert("password".to_string(), "Geohot66".to_string());
    RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["115.190.80.132"];
pub const RS_PUB_KEY: &str = "bY1t1pJ6zffSHbTUQcNWUlwV3U0EyspNbVPDiRbvbX0=";
